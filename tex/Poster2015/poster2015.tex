...
\item Diferenças finitas - método usado para discretizar equações \begin{align}
  f''(x) \approx \frac{f(x+h) - 2f(x) + f(x-h)}{h^2}
\end{align}
\item Time-splitting \cite{chorin68} - técnica para se resolver a equação de Navier Stokes \begin{align}
...
\captionof{figure}{Malha escalonada\label{staggered-grid}}
	...
	\begin{itemize}
	  \item Difusão estável \begin{align}
	    \Delta t < \frac{1}{4}\mathit{Re}\Delta x^2
	  \end{align}
	  \item Advecção estável \begin{align}
	    \Delta t < \frac{\Delta x}{U}
	  \end{align}
	  \item Camada limite hidrodinâmica \begin{align}
	    \Delta x < \frac{1}{\mathit{Re}}
	  \end{align}
	\end{itemize}
\end{itemize}
}
...
\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/vRe50N100Chi01Cpm0T10fps20.png}
\captionof{figure}{Linhas de velocidade em regime sem campo aplicado}
\end{center}

\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/Re5NoMagnetism.png}
\captionof{figure}{Linhas de velocidade em regime sem campo aplicado}
\end{center}

\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/vortRe50N100Chi01Cpm0T10fps20.png}
\captionof{figure}{Evolução da vorticidade sem campo aplicado}
\end{center}

\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/divBRe50N100Chi05Cpm5T10fps20.png}
\captionof{figure}{$\nabla\cdot\mathbf{B}$ máximo calculado na malha}
\end{center}

\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/vRe50N100Chi05Cpm5T10fps20.png}
\captionof{figure}{Linhas de velocidade em regime com campo aplicado}
\end{center}

\begin{center}
\includegraphics[width=0.90\linewidth]{simulations/Re50Cpm1.png}
\captionof{figure}{Linhas de velocidade em regime com campo aplicado}
\end{center}
...
\headerbox{5. Trabalhos futuros}{name=futureresearch,column=1,span=1,aligned=references,above=bottom}{ % This block is as tall as the references block
\vspace{0.5em}
\begin{itemize}
  \item Deseja-se simular a equação de Shliomis\cite{masao1989} \begin{align}
 ...
 \item É desconhecido se a equação de Shliomis é válida ou não e ela nunca foi resolvida numericamente. Um resultado numérico seria útil para comparação com dados experimentais.
\end{itemize}
