...
#define POISSON_BOUNDARY_CONDITIONS_NAVIER_LEFT -m_dRho*m_dNu*(-5*m_dVelocityXNoPressure(i,j+1)\
												+4*m_dVelocityXNoPressure(i,j+2)\
												-m_dVelocityXNoPressure(i,j+3))/m_dDeltaX \
...
#define POISSON_BOUNDARY_CONDITIONS_NAVIER_RIGHT -m_dRho*m_dNu*(-5*m_dVelocityXNoPressure(i,j-1)\
												+4*m_dVelocityXNoPressure(i,j-2)\
												-m_dVelocityXNoPressure(i,j-3))/m_dDeltaX \
											- (m_dExternalForceX(i,j)+m_dExternalForceX(i,j-1))/(2.0*m_dDeltaX)
...
#define POISSON_BOUNDARY_CONDITIONS_NAVIER_TOP -m_dRho*m_dNu*(-5*m_dVelocityXNoPressure(i+1,j)\
												+4*m_dVelocityXNoPressure(i+2,j)\
												-m_dVelocityXNoPressure(i+3,j))/m_dDeltaX \
...
#define POISSON_BOUNDARY_CONDITIONS_NAVIER_BOTTOM -m_dRho*m_dNu*(-5*m_dVelocityXNoPressure(i-1,j)\
												+4*m_dVelocityXNoPressure(i-2,j)\
												-m_dVelocityXNoPressure(i-3,j))/m_dDeltaX \
											- (m_dExternalForceX(i,j)+m_dExternalForceX(i-1,j))/(2.0*m_dDeltaX)
#endif /*NON_HOMOGENEITY_NAVIER_RIGHT*/
